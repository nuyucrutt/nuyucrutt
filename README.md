...
### 🌐 [External Partnership Projects: Virtual Internship, Revou X TiketQ](https://vi-frontend.tiketq.com)
...
### 🏦 [RevoBank — Final Project](https://github.com/nuyucrutt/RevoBank)
> Developed in the **RevoU Software Engineering Program**  
A modern banking simulation web app featuring responsive UI and dynamic data flow.

### 📰 [nhartikel — Project Milestone 1](https://nhartikel.my.id/)
